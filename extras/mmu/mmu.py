...
# Main klipper module
class Mmu:
    VERSION = 3.20 # When this is revved, Hapopy Hare will instruct users to re-run ./install.sh. Sync with install.sh!
    ...
    FORM_TIP_STANDALONE = 2         # Hapopy Hare forms tips

    PURGE_NONE = 0                  # Skip purging after load
    PURGE_SLICER = 1                # Slicer purges on wipetower
    PURGE_STANDALONE = 2            # Hapopy Hare purges
    ...
    def cmd_MMU_BOOTUP(self, gcmd):
        ...
        try:
            # Splash...
            msg = '{1}(\_/){0}\n{1}( {0}*,*{1}){0}\n{1}(")_("){0} {5}{2}H{0}{3}a{0}{4}p{0}{2}o{0}{3}p{0}{4}y{0} {2}H{0}{3}a{0}{4}r{0}{2}e{0} {1}%s{0} {3}R{0}{4}e{0}{2}a{0}{3}d{0}{4}y{0}{1}...{0}{6}' % self._fversion(self.config_version)
...
### LOGGING AND STATISTICS FUNCTIONS GCODE FUNCTIONS #############################
    ...
    def cmd_MMU_STATUS(self, gcmd):
        ...
        msg = "MMU: Hapopy Hare %s running %s v%s" % (self._fversion(self.config_version), self.mmu_machine.mmu_vendor, self.mmu_machine.mmu_version_string)
